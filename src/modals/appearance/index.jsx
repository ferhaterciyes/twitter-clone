  ...
  return (
    <div className="w-[600px]">
      ...
      <div className="p-8 pt-0">
        <p className="text-center text-[#71767b] leading-5 text-[15px] mb-5">Bu ayarlar, bu tarayıcıdaki tüm X hesaplarını etkiler.</p>
        <div className="mx-8 mb-4">
          <div className="border border-[#2f3336] px-4 flex py-3 gap-3 rounded-2xl">
            <img src="https://pbs.twimg.com/profile_images/1683899100922511378/5lY42eHs_bigger.jpg"
             alt=""

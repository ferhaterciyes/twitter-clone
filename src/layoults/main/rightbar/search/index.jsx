...
const Search = () => {
  ...
  return (
    <div
      ref={ref}
      className="min-h-[2rem] h-[3.313rem] mb-3 flex items-center sticky top-0 bg-[color:var(--backgraund-primary)] z-10"
      >
    <label className="h-[2.688rem] rounded-full bg-[color:var(--backgraund-third)] w-full relative group border border-transparent focus-within:bg-[color:var(--backgraund-primary)] focus-within:border-[color:var(--color-primary)]">
      ...
      {focus &&  (<div
					className="absolute w-[350px] top-full -left-px -translate-y-1 bg-[color:var(--backgraund-primary)] shadow-box max-h-[calc(80vh-53px)] rounded-lg text-center min-h-[100px]">

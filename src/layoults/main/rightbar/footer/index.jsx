    ...
    <div className="inline-flex gap-2 flex-wrap">
      <Popover className="relative inline-flex leading-4">
        <Popover.Button className="text-[color:var(--color-base-secondary)] outline-none leading-4 hover:underline inline-flex items-center">
          ...
          <Popover.Panel className="w-[9.375rem] max-w-[24rem] bg-[color:var(--backgraund-primary)] shadow-box rounded-xl absolute bottom-0 right-0 grid overflow-hidden">
						<Link to="/" className="py-3 px-4 leading-5 font-bold hover:bg-[color:var(--backgraund-secondary)] transition-colors">
							Hakkında
						</Link>
            <Link to="/" className="py-3 px-4 leading-5 font-bold hover:bg-[color:var(--backgraund-secondary)] transition-colors">
							Durum

...
const Premium = () => {
  return (
    <section className="bg-[color:var(--backgraund-secondary)] mb-4 rounded-2xl border border-[color:var(--backgraund-secondary)] py-3 px-4 flex flex-col gap-2.5 text-[#e7e9ea]">

    ...
    <Popover className="relative ">
      ...
      <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-[color:var(--backgraund-primary)] shadow-box rounded-xl overflow-hidden">
        ...
        <Disclosure>
          {({open})=> (
           <>
                 <Disclosure.Button className="flex items-center justify-between w-full p-4 font-bold hover:bg-[color:var(--backgraund-secondary)] transition-colors">
               ...
               <Disclosure.Panel >
                 <Link
                   to={"/"}
                   className="flex items-center px-3 h-11 gap-3 font-medium hover:bg-[color:var(--backgraund-secondary)] transition-colors">
     ...
     <Disclosure.Button className="flex items-center justify-between w-full p-4 font-bold hover:bg-[color:var(--backgraund-secondary)] transition-colors">
          ...
          <Disclosure.Panel>
            ...
            <button 
              ...
              className="flex items-center px-3 h-11 w-full gap-3 font-medium hover:bg-[color:var(--backgraund-secondary)] transition-colors"
              >
<svg viewBox="0 0 24 24" className="h-[1.172rem]">  
              <path
                  fill="currentColor"
